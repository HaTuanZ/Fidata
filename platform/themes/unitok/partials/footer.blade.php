                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
                            ...
                            <p class="footer__tagline">{!! BaseHelper::clean(theme_option('seo_description')) !!}</p>
                            ...
                            <div class="footer__lang">
                                <a class="footer__lang-btn" href="#" role="button" id="dropdownLang" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img src="{{ Theme::asset()->url('img/flags/uk.svg') }}" alt="">
                                    <span>English</span>
                                </a>
                                <ul class="dropdown-menu footer__lang-dropdown" aria-labelledby="dropdownLang">
                                    <li><a href="#"><img src="{{ Theme::asset()->url('img/flags/spain.svg') }}" alt=""><span>Spanish</span></a></li>
                                    <li><a href="#"><img src="{{ Theme::asset()->url('img/flags/russia.svg') }}" alt=""><span>Russian</span></a></li>
                                    <li><a href="#"><img src="{{ Theme::asset()->url('img/flags/china.svg') }}" alt=""><span>Chinese</span></a></li>
                                </ul>
                            </div>
                        </div>

                        <div class="col-6 col-md-4 col-lg-3 col-xl-2 order-1 order-md-2 order-lg-1 order-xl-2 offset-md-2 offset-lg-0">
                            <h6 class="footer__title">DEFICOPY</h6>
                            <div class="footer__nav">
                                <a href="https://docs.deficopy.net/faq/fees-pricing">Fees/Pricing</a>
                                <a href="#">Apply Master trader</a>
                                <a href="https://docs.deficopy.net/deposit">Guide</a>
                                <a href="https://docs.deficopy.net/ecucation/basic-course">Education</a>
                                <a href="https://docs.deficopy.net/tradingbot-autotrade/manual">Trading bot</a>
                                <a href="https://docs.deficopy.net/marketplace/copy-trading">Marketplace</a>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-8 col-lg-6 col-xl-4 order-3 order-lg-2 order-md-3 order-xl-3">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="footer__nav">
                                        <a href="#">API</a>
                                        <a href="https://docs.deficopy.net/faq/referral-program">Affiliate Information</a>
                                        <a href="https://docs.deficopy.net/faq/introduction">FAQ</a>
                                        <a href="https://coingen.net/login">Login</a>
                                    </div>
                                </div>

                                <div class="col-6">
                                    <div class="footer__nav">
                                        <a href="https://docs.deficopy.net">About Us</a>
                                        <a href="https://coingen.net/user/support">Support</a>
                                        <a href="https://docs.deficopy.net/contact-defi-copy">Contact Us</a>
                                        <a href="https://docs.deficopy.net/what-is-deficopy">Privacy Policy</a>
                                        <a href="https://docs.deficopy.net/terms-of-use">User Agreement</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2 order-2 order-lg-3 order-md-4 order-xl-4">
                            ...
                            <div class="footer__nav">
                                <a href="https://coingen.net/user/news">Blog</a>
                                <a href="#">Telegram</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="footer__content">
                                ...
                                <small class="footer__copyright">{!! BaseHelper::clean(theme_option('copyright')) !!}</small>
                            </div>
                        </div>
                    </div>
                </div>
