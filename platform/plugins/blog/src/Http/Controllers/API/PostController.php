...
use SlugHelper;
use Botble\Blog\Http\Resources\UserResource;
...
class PostController extends Controller
{
    ...
    public function findByCategories(Request $request, BaseHttpResponse $response) {
		...
		*/
	    ...
	    $data = $this->postRepository->getByEachCategory($category_id, $offset, $limit);
    ...
    public function findAuthorById($id, BaseHttpResponse $response) {
	    $user = $this->userRepository->findOrFail($id);
	    $data = array("id" => $user->id, "first_name" => $user->first_name, "last_name" => $user->last_name, "name" => $user->first_name." ".$user->last_name, "created_at" => $user->created_at );
