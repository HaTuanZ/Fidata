...
use Botble\Blog\Repositories\Caches\AccountCacheDecorator;
use Botble\Blog\Repositories\Eloquent\AccountRepository;
use Botble\Blog\Models\Account;
...
class BlogServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
	    ...
	    $this->app->booted(function () {
		    $this->app->make(Schedule::class)->command(CoinstatsNewsCommand::class)->cron('5 */2 * * *');
		    $this->app->make(Schedule::class)->command(CoinstatsNewsTrendingCommand::class)->cron('15 */2 * * *');
		    $this->app->make(Schedule::class)->command(CoinstatsNewsBullishCommand::class)->cron('30 */2 * * *');
		    $this->app->make(Schedule::class)->command(CoinstatsNewsBearishCommand::class)->cron('45 */2 * * *');
		    $this->app->make(Schedule::class)->command(CoinstatsNewsHandpickedCommand::class)->cron('01 */2 * * *');
		    $this->app->make(Schedule::class)->command(CoinstatsNewsLatestCommand::class)->cron('39 */2 * * *');
	    });
