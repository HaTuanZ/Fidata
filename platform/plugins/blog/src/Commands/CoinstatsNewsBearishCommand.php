...
class CoinstatsNewsBearishCommand extends Command {

	public $postRepository;
	public $slugRepository;

	protected $signature = 'blog:coinstats-news-bearish';

	protected $description = 'Get news bearish list from Coinstats';
	...
	public function handle() {
		...
		$skip = 0;
		$limit = 20;
		$endpoint = "https://api.coinstats.app/public/v1/news/bearish?skip=$skip&limit=$limit";
