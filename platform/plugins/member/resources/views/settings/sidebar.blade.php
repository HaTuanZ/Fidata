<div class="col-12 col-md-3">
  <div class="list-group mb-3 br2" style="box-shadow: rgb(204, 204, 204) 0px 1px 1px;">
    ...
    <a href="{{ route('public.member.referrer') }}" class="list-group-item list-group-item-action bn @if (Route::currentRouteName() == 'public.member.referrer') active @endif">
      <i class="fas fa-link mr-2"></i>
      <span>{{ trans('plugins/member::dashboard.sidebar_referrer') }}</span>
    </a>
  </div>
</div>
